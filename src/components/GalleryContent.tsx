    ...
    <div className="min-h-screen bg-[#0a1931]">
      ...
      <main className="container mx-auto px-4 py-20">
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl font-bold text-white mb-4">Event Gallery</h1>
          <p className="text-white/80 max-w-2xl mx-auto">
            Relive the moments from previous TechHack events. Browse through our collection of memories and achievements.
          </p>
        </div>
