...
const Prizes: React.FC = () => {
  ...
  const mainPrizes = [
    {
      position: "1st Place",
      icon: <Trophy className="h-12 w-12 text-[#f5b7b1]" />,
      prize: "$25,000",
      color: "from-[#9d2449] to-[#4a2172]",
      benefits: [
    ...
    {
      position: "2nd Place",
      icon: <Award className="h-12 w-12 text-[#f5b7b1]" />,
      prize: "$15,000",
      color: "from-[#301b47] to-[#4a2172]",
      benefits: [
    ...
    {
      position: "3rd Place",
      icon: <Star className="h-12 w-12 text-[#f5b7b1]" />,
      prize: "$10,000",
      color: "from-[#11234a] to-[#301b47]",
      benefits: [
